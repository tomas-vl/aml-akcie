...
predicted_training_data <- data.frame(close = predict(model, newdata = training_data), date=training_data$date)

predicted_testing_data <- data.frame(close = predict(model, newdata = testing_data), date=testing_data$date)
